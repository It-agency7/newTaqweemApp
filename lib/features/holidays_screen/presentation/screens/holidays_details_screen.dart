...
class HolidaysDetailsScreen extends StatefulWidget {
  final NoteModel note;
  const HolidaysDetailsScreen({super.key, required this.note});

  @override
  State<HolidaysDetailsScreen> createState() => _HolidaysDetailsScreenState();
}

class _HolidaysDetailsScreenState extends State<HolidaysDetailsScreen> {
  late NoteModel note;
  @override
  void initState() {
    note = widget.note;
  ...
  Widget build(BuildContext context) {
    ...
    final DateTime timeWill = DateTime.parse(note.date)
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          note.description.replaceFirst('<p>', '').replaceAll('</p>', ''),
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                ...
                                style: const TextStyle(fontSize: 10, color: ColorManager.white),
                              ),
                            ),
                                              ...
                                              children: [
                                                ...
                                                Checkbox(
                                                  ...
                                                  onChanged: (isFinished) {
                                                    ...
                                                    setState(() {
                                                      note.tasks[index] = newTask;
                                                    });
                                                    BlocProvider.of<NotesCubit>(context).updateTask(newTask: newTask);
                                                  },
                                                ),
                                              ],
                                            ),
